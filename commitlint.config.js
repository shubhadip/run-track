 ...
 * X.Y.Z => Release versioning format
  ...
  - feat(pencil): new feature added => Will bump up Y

  - perf(pencil): major project overhaul changes released => Will bump the X

  - BREAKING CHANGE: any breaking released  => Will bump the Y
