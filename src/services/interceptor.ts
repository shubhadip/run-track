// import { ErrorCode, IGenericOption } from '@/shared/interface';
...
//  * @param errorConfig
//  */
// export const retryHandler = (errorConfig: any): IGenericOption | undefined => {
//   try {
//     // refetch new accessToken and continue
//     // if this fails open login modal
//     return apiClient.request(errorConfig.config) as IGenericOption;
//   } catch (err) {
